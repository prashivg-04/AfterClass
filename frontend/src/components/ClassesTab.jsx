    ...
    <div className="space-y-6">
      ...
      {isTeacher && (
        <div className="flex items-center justify-between bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          <div>
            <h3 className="text-xl font-bold text-slate-900">Classes</h3>
            <p className="text-sm text-slate-500 mt-1">Manage all your scheduled classes and lessons</p>
          </div>
          <button
            onClick={() => setShowModal(true)}
            className="flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 shadow-sm transition-all hover:shadow hover:-translate-y-0.5"
          >
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        {!isTeacher && (
          <div className="p-6 border-b border-slate-100 bg-slate-50/50">
            <h3 className="text-xl font-bold text-slate-900">Classes</h3>
            <p className="text-sm text-slate-500 mt-1">View your upcoming and past classes</p>
          </div>
        )}
        {classes.length === 0 ? (
