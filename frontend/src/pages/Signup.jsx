  ...
  return (
    <AuthLayout>
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full" noValidate>
        ...
        <div className="md:col-span-2 bg-white border border-slate-200/80 rounded-3xl md:rounded-4xl p-5 md:p-6 focus-within:bg-emerald-50/30 focus-within:border-emerald-300 transition-all group relative overflow-hidden shadow-sm hover:shadow-md">
        ...
        {/* Email Input Tile */}
        <div className="bg-white border border-slate-200/80 rounded-3xl md:rounded-4xl p-5 md:p-6 focus-within:bg-indigo-50/30 focus-within:border-indigo-300 transition-all group relative overflow-hidden shadow-sm hover:shadow-md">
        ...
        {/* Password Input Tile */}
        <div className="bg-white border border-slate-200/80 rounded-3xl md:rounded-4xl p-5 md:p-6 focus-within:bg-purple-50/30 focus-within:border-purple-300 transition-all group relative overflow-hidden shadow-sm hover:shadow-md">
